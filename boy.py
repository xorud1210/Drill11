...
class Idle:
    ...
    @staticmethod
    def do(boy):
        boy.frame = (boy.frame + FRAMES_PER_TIME * game_framework.frame_time) % FRAMES_PER_ACTION
...
class Sleep:
    ...
    @staticmethod
    def do(boy):
        boy.frame = (int(boy.frame) + FRAMES_PER_TIME * game_framework.frame_time) % FRAMES_PER_ACTION
